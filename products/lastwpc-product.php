...
function add_wpcproduct_metaboxes() {
    ...
    add_meta_box('wpt_product_acabado', 'Acabado', 'wpt_product_acabado', 'wpcproduct', 'side');
   add_meta_box('wpt_product_cat', 'Categoria', 'wpt_product_cat', 'wpcproduct', 'side');
    add_meta_box('wpt_product_uso', 'Uso', 'wpt_product_uso', 'wpcproduct', 'side');
	add_meta_box('wpt_product_color', 'Color', 'wpt_product_color', 'wpcproduct', 'side');
	add_meta_box('wpt_product_marca', 'Marca', 'wpt_product_marca', 'wpcproduct', 'side');
	add_meta_box('wpt_product_forato', 'Formato', 'wpt_product_formato', 'wpcproduct', 'side');
	add_meta_box('wpt_product_estilo', 'Estilo', 'wpt_product_estilo', 'wpcproduct', 'side');
	 add_meta_box('wpt_product_col', 'Coleccion', 'wpt_product_col', 'wpcproduct', 'side');
	   }
...
function wpt_product_cat() {
 ...
 // Get the location data if its already been entered
    ...
    $product_var = get_post_meta($post->ID, 'product_cat', true);
 // Echo out the field
 echo '<input type="text" name="product_cat" value="'.$product_var.'">';


}
function wpt_product_uso() {
    global $post;
 // Noncename needed to verify where the data originated
//    echo '<input type="hidden" name="itemmeta_noncename" id="itemmeta_noncename" value="" />'; 
 //   wp_create_nonce( plugin_basename(__FILE__) ) */.
 ...
 // Get the location data if its already been entered
    ...
    $product_var = get_post_meta($post->ID, 'product_uso', true);
 // Echo out the field
 echo '<input type="text" name="product_uso" value="'.$product_var.'">';


}
function wpt_product_color() {
    global $post;
 // Noncename needed to verify where the data originated
//    echo '<input type="hidden" name="itemmeta_noncename" id="itemmeta_noncename" value="" />'; 
 //   wp_create_nonce( plugin_basename(__FILE__) ) */.
 ...
 // Get the location data if its already been entered
    ...
    $product_var = get_post_meta($post->ID, 'product_color', true);
 // Echo out the field
 echo '<input type="text" name="product_color" value="'.$product_var.'">';


}

function wpt_product_acabado() {
    global $post;
 ...
 // Get the location data if its already been entered
    ...
    $product_ac = get_post_meta($post->ID, 'product_acabado', true);
 // Echo out the field
 */
 echo '<input type="text" name="product_acabado" value="'.$product_ac.'">';


}

function wpt_product_marca() {
    global $post;
 ...
 // Echo out the field
 */
 echo '<input type="text" name="product_marca" value="'.$product_ac.'">';


}
function wpt_product_formato() {
    global $post;
 ...
 // Echo out the field
 */
 echo '<input type="text" name="product_firmato" value="'.$product_ac.'">';


}

function wpt_product_estilo() {
    global $post;
 ...
 // Echo out the field
 */
 echo '<input type="text" name="product_estilo" value="'.$product_ac.'">';


}

function wpt_product_col() {
///filtro por coleccion
 ...
 // Echo out the field
 */
 echo '<input type="text" name="product_col" value="'.$product_ac.'">';
